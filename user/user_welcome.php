...
while($row = mysqli_fetch_assoc($result)){
    ...
    echo'
    <div class="container " style="max-width:70%" data-aos="fade-right">
<div class="card  m-4">
    ...
    <div class="card-body">
        ...
        <h5 class="card-title">Salary : '.$job_salary.'</h5>
        <p class="card-text">Location : '.$job_address.'
        </p>
        <p class="card-text">Skills : '.$job_skills.'</p>
        <p class="card-text">About :'.$job_about.'</p>
        <p class="card-text">Posted  on : '.$job_datetime.'</p>
...
?>-->
    ...
    <div class="container ">
        <div class="container bg-dark p-4 mt-4 " id="search">

            <form class="form-inline " action="user_search.php" method="GET">
                <input name="job_name" class="form-control ml-2" style="width:88%;height:3rem;background-color:#fedc19;"
                    type="search" placeholder="Search" aria-label="Search">
                <button class="btn btn-light ml-2 p-2 pl-4 pr-4 mt-2" type="submit">Search</button>
            </form>
    ...
    <?php
                ...
                <div class="row">
                        ...
                        <a href="apply_job.php?job_id='.$job_id.'&job_name='.$job_name.'&comp_id='.$comp_id.'&comp_name='.$comp_name.'" class="btn btn-primary btn-apply mt-4">Apply</a>
    ...
    <span class="card-title card-header-name font-weight-bold"><i class="far fa-building card-header-name"></i> &nbsp;&nbsp;&nbsp;&nbsp;'.$comp_name.'</span>
                    ...
                    <a href="apply_job.php?job_id='.$job_id.'&job_name='.$job_name.'&comp_id='.$comp_id.'&comp_name='.$comp_name.'" class="btn btn-primary btn-apply">Apply</a> -->
