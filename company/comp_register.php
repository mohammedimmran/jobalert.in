...
<body>
    ...
    $comp_password = $_POST['comp_password'];
     ...
     $select = "SELECT * FROM `company_db` WHERE `comp_name` = '$comp_name'"; 
    ...
    $sql = "INSERT INTO `company_db` ( `comp_name`, `comp_email`, `comp_password`, `comp_address`, `comp_about`, `datetime`)
            VALUES ('$comp_name', '$comp_email', '$comp_password', '$comp_address', '$comp_about', current_timestamp())";
        ...
        <div class="container" id="header">
            <div class="row">
                <div class="container col-sm-6" style="height:100vh;">
                    <h1 class="text text-uppercase ">Company Registration</h1>
                    <form method="POST" data-aos="fade-right">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="comp_address" name="comp_address" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">About</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="comp_about"
                                rows="3"></textarea>
                        </div>
                        ...
                        <button type="submit" class="btn btn-submit font-weight-leight m-2"
                            name="register">Submit</button>
                        <a href="comp_login.php">Already have an account ? login here</a>
                    </form>
                </div>
